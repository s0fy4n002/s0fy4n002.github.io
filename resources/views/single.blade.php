            ...
            <div class="col-lg-10 col-lg-offset-1">
                <article class="hentry post post-standard-details">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post-additional-info">
                            ...
                            <span class="post__date">
                                ...
                                <time class="published" datetime="20-03-2020 12:00:00">
                    ...
                    <div class="socials">
                        ...
                        <div class="addthis_inline_share_toolbox_kggb"></div>
                    </div>
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        <img src="{{ asset('storage/'.$post->users->profile->avatar) }}" style="width: 70px;height: 70px;" alt="Author">
                    </div>

                    <div class="blog-details-author-content">
                        <div class="author-info">
                            <h5 class="author-name">{{$post->users->name}}</h5>
                            <p class="author-info"></p>
                        </div>
                        <p class="text">{{$post->users->profile->about}}
                        </p>
                        <div class="socials">

                            <a href="http://www.{{$post->users->profile->facebook}}" target="_blank" class="social__item">
                                <img src="{{ asset('app/svg/circle-facebook.svg') }}" alt="facebook">
                            </a>

                            <a href="http://www.{{$post->users->profile->youtube}}" target="_blank" class="social__item">
